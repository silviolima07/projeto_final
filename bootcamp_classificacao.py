...
Foram aplicadas diversas estratégias para lidar com o desbalanceamento:
...
print(df_test[['id', 'id_produto', 'probabilidade_falha (%)']])
...
print(multilabel_cases)

print("\nContagem total de 'sim' por linha:")
print(df_falhas_sim['sim_count'].value_counts())
...
print(df_multiclasse.head())

print("\nContagem dos tipos de falha para classificação multiclasse:")
print(df_multiclasse['tipo_falha'].value_counts())
